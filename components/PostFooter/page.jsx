  ...
  return (
    <>
      <section className="view1 monuments relative">
        ...
        />
        <div className="absolute bottom-16 md:bottom-20 left-0 w-full h-full flex items-center justify-center">
          <p
            className="text-red-500 font-bold md:text-6xl sm:text-4xl text-2xl text-shadow-lg"
