...
const Collection = () => {
      ...
      <div className="jiu">
        ...
        <div className="containeri">
          ...
          <div className="blog-post">
            <img
              src="https://images.unsplash.com/photo-1629941181163-cdfb4bce340c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"
              alt="Man"
            />
            <a href="https://youtu.be/SdNaoYS_6Fo" target="_blank" className="category">
              Insparation
            </a>
            <div className="text-content">
              <img
                src="https://images.unsplash.com/photo-1485893226355-9a1c32a0c81e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                alt=""
              />
              ...
              <div className="tags">
                <a href="https://youtu.be/SdNaoYS_6Fo" target="_blank">
                  #design
                </a>
                <a href="https://youtu.be/SdNaoYS_6Fo" target="_blank">
                  #photo
  ...
  <div className="slide-track">
    ...
    <div className="slide">
      <Image 
       src="/images/icon/icons8-on-time-delivery-53.png"  height={100}
        width={250}
        alt=""
      />
    </div>
