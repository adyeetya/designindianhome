            ...
            <div className="mt-30px">
                ...
                <div className="flex flex-col items-center md:flex-row justify-center gap-6 md:gap-32 w-full mt-5">
                    ...
                    <div className="text-center">
                        <img src="images/dkilogo.png" alt="" style={{ width: '200px', height: '80px' }} />
                ...
                <div className="flex flex-col items-center md:flex-row justify-center bg-gray-200 p-10 gap-6 mt-10 text-black">
                    {/* Feature 1 */}
                    <div className="text-center">
                        <img src="images/warranty.png" alt="" className="w-30 h-20 mx-auto" />
                    ...
                    {/* Feature 2 */}
                    <div className="text-center mt-4 md:mt-0">
                        <img src="images/fast-delivery.png" alt="" className="w-30 h-20 mx-auto" />
                    ...
                    {/* Feature 3 */}
                    <div className="text-center mt-4 md:mt-0">
                        <img src="images/team-building.png" alt="" className="w-30 h-20 mx-auto" />
                    ...
                    {/* Feature 4 */}
                    <div className="text-center mt-4 md:mt-0">
                        <img src="images/customer-service.png" alt="" className="w-30 h-20 mx-auto" />
                ...
                <div className="flex flex-col md:flex-row justify-center bg-gray-200 gap-6 p-6  text-black">
                    ...
                    <div className="text-left">
                        <img src="images/desig indian homes.gif" alt="footer logo" className="w-30 h-20" />
                    ...
                    <div>
                        <img src="images/homes-gif-logo-optimize.gif" alt="" className="w-60 h-30" />
                    </div>
