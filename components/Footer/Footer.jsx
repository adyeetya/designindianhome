...
const DesignIdeasDropdownContainer = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 gap-y-16">
            ...
            {/* <h3 className="font-bold">Interior</h3>
              <ul className="leading-7 text-sm">
                ...
                <Link href="/bungalow-interior-designs">
                  <li>Bungalow interior designs</li>{" "}
                </Link>
            ...
            {/* <div>
              ...
              <ul className="leading-7 text-sm">
                ...
                <Link href="/top-architects-in-india">
                  <li>End to End Structural Projects</li>
                </Link>
            ...
            {/* <div>
              ...
              <ul className="leading-7 text-sm">
                <Link href="/modular-kitchen-types">
                  <li>Types of Modular Kitchen</li>
                </Link>
            ...
            {/* <div>
              ...
              <ul className="leading-7 text-sm">
                ...
                <Link href="/wardrobe-renovation-services">
                  {" "}
                  <li>Wardrobe Renovation Services</li>
                </Link>
              </ul>
            </div> */}
            {/* <div>
              ...
              <div style={{ width: "300px" }}>
                ...
                <div className="mt-8 text-sm">
                  <p className="mb-4 font-bold">
                    DESIGNING & OPERATIONS OFFICE 25/42, A BLOCK, MIDDLE CIRCLE,
                    CONNAUGHT PLACE, NEW DELHI - 110001 NEAR RAJIV CHOWK METRO
                    STN, GATE NO.8{" "}
                  </p>
                  <p className="mb-4 font-bold">
                    CORPORATE INDUSTRIAL UNIT G - 984, NARELA DSIIDC INDUSTRIAL
                    AREA, NEW DELHI - 110040
                  </p>
                  <p className="mb-4 font-bold">
                    largest-modular-kitchen-brand-india 0-9899264978 /
                    0-9582827928/ 0-9899239097 LANDLINE - 01144127897
                    best-modular-kitchen-brand-in-delhi-gurgaon-noida-india
                    ENQUIRY@DESIGNINDIANKITCHEN.COM modular-kitchen-in-delhi
                    MONDAY - SATURDAY: 10:30 AM - 7:30 PM
                    modular-kitchen-dealers-in-delhi SUNDAY: 11:00 AM - 7:00 PM
    ...
    <div className="colors-modular-kitchen my-12">
        ...
        <div className="text-center text-black text-sm  py-4 bg-white">
          <p>
            ...
            BY IN HOUSE BRAND - THE DESIGNER LOUNGE | PRIVACY | LEGAL | SITEMAP
          </p>
        </div>
      </div>
    );
