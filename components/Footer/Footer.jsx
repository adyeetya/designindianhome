            ...
            <div className="mt-30px">
                ...
                <div className="flex flex-col items-center md:flex-row justify-center gap-6 md:gap-32 w-full mt-5">
                    ...
                    <div className="text-center">
                        <Image src="/design-Indian-home-about-us.jpg" alt="" width={200} height={80} />
                    ...
                    <div className="text-center mt-4 md:mt-0">
                        <Image src="/images/desig indian homes.gif" alt="" width={200} height={80} />
                        <p className="text-green-500 text-2xl font-medium">Design Indian Home</p>
                    </div>

                    {/* Brand 3 */}
                    <div className="text-center mt-4 md:mt-0">
                        <Image src="/images/footer-logo-multi.png" alt="" width={200} height={80} />
                ...
                <div className="flex flex-col items-center md:flex-row justify-center bg-gray-200 p-10 gap-6 mt-10 text-black">
                    {/* Feature 1 */}
                    <div className="text-center">
                        <Image src="/images/warranty.png" alt="" width={128} height={80}/>
                    ...
                    {/* Feature 2 */}
                    <div className="text-center mt-4 md:mt-0">
                        <Image src="/images/fast-delivery.png" alt=""  width={128} height={80}/>
                    ...
                    {/* Feature 3 */}
                    <div className="text-center mt-4 md:mt-0">
                        <Image src="/images/team-building.png" alt=""  width={128} height={80}/>
                    ...
                    {/* Feature 4 */}
                    <div className="text-center mt-4 md:mt-0">
                        <Image src="/images/customer-service.png" alt=""  width={128} height={80}/>
                ...
                <div className="flex flex-col md:flex-row justify-center bg-gray-200 gap-6 p-6  text-black">
                    ...
                    <div className="text-left">
                        <Image src="/images/design indian homes.gif" alt="footer logo"  width={128} height={80} />
                    ...
                    <div>
                        <Image src="/homes-gif-logo-optimize.gif" alt=""  width={128} height={80} />
                    </div>
